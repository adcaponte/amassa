...
- tests/e2e/queimas-registro.spec.ts:84 (celular) falha com `element is not stable` ao clicar em "Desfazer" dentro de um toast do `sonner` ainda em animacao. Defeito real do teste, nao instabilidade de ambiente: em HEAD ele falhava no desktop MESMO com 2 retentativas — ver quick 260811-2jb
